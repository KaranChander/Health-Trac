//
//  ReadingStepThreeView.swift
//   Health Track


import UIKit

class ReadingStepThreeView: UIView {
...
//====================================================
extension ReadingStepThreeView: UITextViewDelegate {
    ...
    func textView(_ textView: UITextView, shouldChangeTextIn range: NSRange, replacementText text: String) -> Bool {
        ...
        if updatedText.isEmpty {
            ...
            return textView.textLimit(newText: text, limit: 100)
        }
        return true
    }
